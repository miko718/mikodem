...
### 1. הגדרת Google Cloud Console

1. עבור ל-[Google Cloud Console](https://console.cloud.google.com/)
2. צור פרויקט חדש
3. הפעל את **Google Calendar API** ו-**Google+ API** (או People API)
...
2. **30 דקות לפני פגישה** – המערכת מציגה את הפגישות בטווח
3. **שליחת קישור ללקוח** – "העתק קישור ל-SMS/WhatsApp" ושלח ללקוח
4. **הלקוח** לוחץ על הקישור, משתף מיקום
